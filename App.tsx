        ...
        <aside className="w-full lg:w-80 flex flex-col gap-8 order-2 lg:order-1">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.s} className="flex items-center gap-4">
                   <span className="font-mono bg-gray-100 px-2 py-1 rounded-lg text-[12px] font-black text-gray-700">{item.s}</span> 
                   <span className="text-[11px] text-gray-500 font-semibold leading-none">{item.d}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-[32px] p-7 shadow-sm border border-gray-100 mt-auto">
             <div className="flex justify-between items-center mb-4">
                <span className="text-[10px] font-black uppercase text-gray-400 tracking-[.2em]">ENGINE QUOTA</span>
        ...
        <section className="flex-1 flex flex-col gap-8 order-1 lg:order-2">
          ...
          <div className="bg-white rounded-[56px] shadow-2xl shadow-gray-200/60 border border-gray-50 p-8 md:p-16 flex flex-col flex-1 min-h-[550px]">
            ...
            <div className="mt-14 flex flex-wrap items-end justify-between gap-10">
               ...
               >
                 {isSynthesizing ? 'RECORDING SESSION...' : `Commit Narrative Take`}
               </button>
            </div>
          </div>
        </section>
